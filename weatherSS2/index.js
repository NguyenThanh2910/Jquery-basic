  ...
  $(".search").on("click", function () {
    ...
    $.ajax({
      ...
      success: function (json) {
        ...
        $(".weather-detail ").removeClass("d-none");
      },
      error: function () {
        // Set the "not found" image and clear the weather info
        const image = $(".img-weather");
        image.attr("src", "./images/404.png");
        $('body').css('background-image', 'url(./images/404-not.jpg)');
        $(".temperature-text").html("");
        $(".description").html("Không tìm thấy thành phố");
        $(".weather-detail ").addClass("d-none");
    }
    });
  });
});